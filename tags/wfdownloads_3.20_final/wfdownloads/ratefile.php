...
if (!empty($_POST['submit']))
{
    ...
    if ($ratinguser != 0)
    {
        ...
        $criteria->add(new icms_db_criteria_Item("ratinguser", $ratinguser));
    ...
    else
    {
        ...
        $criteria = new icms_db_criteria_Compo(new icms_db_criteria_Item("lid", $lid));
        $criteria->add(new icms_db_criteria_Item("ratinguser", 0));
        $criteria->add(new icms_db_criteria_Item("ratinghostname", $ip));
        $criteria->add(new icms_db_criteria_Item("ratingtimestamp", $yesterday, ">"));
