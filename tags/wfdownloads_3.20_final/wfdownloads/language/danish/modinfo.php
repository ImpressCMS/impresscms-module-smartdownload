...
define('_MI_WFD_GLOBAL_NEWCATEGORY_NOTIFYDSC', 'Modtag orientering når en ny fil oprettes.');
...
define('_MI_WFD_GLOBAL_FILEMODIFY_NOTIFYCAP', 'Orientér mig ved alle fil redigereinger.');
define('_MI_WFD_GLOBAL_FILEMODIFY_NOTIFYDSC', 'Modtag orientering ved alle fil ændringer er indsendt.');
define('_MI_WFD_GLOBAL_FILEMODIFY_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-orientering: Ønske om filredigering');

define('_MI_WFD_GLOBAL_FILEBROKEN_NOTIFY', 'Brudte filer indsendt.');
define('_MI_WFD_GLOBAL_FILEBROKEN_NOTIFYCAP', 'Orientér mig ved alle brudte filer.');
define('_MI_WFD_GLOBAL_FILEBROKEN_NOTIFYDSC', 'Modtag en orientering når en brudt fil rapporteres.');
...
define('_MI_WFD_GLOBAL_FILESUBMIT_NOTIFYCAP', 'Orientér mig når en ny fil er indsendt (og afventer godkendelse)');
define('_MI_WFD_GLOBAL_FILESUBMIT_NOTIFYDSC', 'Modtag orientering når en ny fil er indsendt og afventer godkendelse');
...
define('_MI_WFD_GLOBAL_NEWFILE_NOTIFYCAP', 'Orientér mig når nye filer er indsendt.');
define('_MI_WFD_GLOBAL_NEWFILE_NOTIFYDSC', 'Modtag orientering når der er indsendt nye filer.');
...
define('_MI_WFD_CATEGORY_FILESUBMIT_NOTIFYCAP', 'Orientér mig når en ny fil er indsendt (og afventer godkendelse) i den aktuelle kategori.');   
define('_MI_WFD_CATEGORY_FILESUBMIT_NOTIFYDSC', 'Modtag orientering når en ny fil er indsendt (og afventer godkendelse) i den aktuelle kategori.');      
...
define('_MI_WFD_CATEGORY_NEWFILE_NOTIFYCAP', 'Orientér mig når en fil offentliggøres i denne kategori.');   
define('_MI_WFD_CATEGORY_NEWFILE_NOTIFYDSC', 'Modtag orientering når en ny fil er offentliggjort i denne kategori.');      
...
define('_MI_WFD_FILE_APPROVE_NOTIFYCAP', 'Orientér mig når en fil er godkendt	.');
define('_MI_WFD_FILE_APPROVE_NOTIFYDSC', 'Modtag orientering når en fil er godkendt	.');
...
define('_MI_WFD_FILE_FILEMODIFIED_NOTIFYCAP', 'Orientér mig når en fil er redigeret.	.');
define('_MI_WFD_FILE_FILEMODIFIED_NOTIFYDSC', 'Modtag orientering når en fil er redigeret.');
...
define('_MI_WFD_CATEGORY_FILEMODIFIED_NOTIFYCAP', 'Orientér mig når en fil i denne kategori er redigeret.');
define('_MI_WFD_CATEGORY_FILEMODIFIED_NOTIFYDSC', 'Modtag orientering når en fil i denne kategori er redigeret..');
...
define('_MI_WFD_GLOBAL_FILEMODIFIED_NOTIFYCAP', 'Orientér mig når en hvilken som helst fil er redigeret.');
define('_MI_WFD_GLOBAL_FILEMODIFIED_NOTIFYDSC', 'Modtag orientering når en fil er redigeret.');
