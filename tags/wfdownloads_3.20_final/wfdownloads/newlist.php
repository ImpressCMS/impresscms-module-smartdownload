...
$criteria = new icms_db_criteria_Item("published", $one_week_ago, ">=");
...
$criteria = new icms_db_criteria_Item("published", $one_month_ago, ">=");
...
if(isset($_GET['newdownloadshowdays'])) {
	...
	if(in_array($days, $days_limit)) {
		...
		$criteria->add(new icms_db_criteria_Item("published",$downloadshowdays, '>='), 'AND');
    }
}
