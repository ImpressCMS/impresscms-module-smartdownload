...
//added for AJAX starrating
define( '_MD_WFD_VOTES', 'Votes' );
define( '_MD_WFD_VOTESLC', 'votes' );
define( '_MD_WFD_CURRATING', 'Current rating.' );
define( '_MD_WFD_RATEDISABLE', 'Rating is disabled.' );
define( '_MD_WFD_OUTOF', ' out of ' );
define( '_MD_WFD_INVALIDVOTE', 'Sorry, vote appears to be invalid.' );
define( '_MD_WFD_THANKYOUVOTING', 'Thanks for voting!' );
?>