...
switch ($op) {
    ...
    default:
        ...
        if (is_object($PDdownloadsModule)) {
            $pddownloadsButton = new XoopsFormButton("Import data from PD-Downloads", "pd_button", "Import", "submit");
            $pddownloadsButton->setExtra("onclick='document.forms.form.op.value=\"2\"'");
            $form->addElement($pddownloadsButton);
        } else {
            $pddownloadsLabel = new XoopsFormLabel("Import data from PD-Downloads", "Module PD-Downloads not found on this site.");
        ...
        if (is_object($wmpdownloadsModule)) {
            $wmpdownloadsButton = new XoopsFormButton("Import data from wmpownloads", "wmp_button", "Import", "submit");
            $wmpdownloadsButton->setExtra("onclick='document.forms.form.op.value=\"3\"'");
            $form->addElement($wmpdownloadsButton);
        } else {
            $wmpdownloadsLabel = new XoopsFormLabel("Import data from wmpownloads", "Module wmpownloads not found on this site.");
