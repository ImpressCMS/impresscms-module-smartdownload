...
$modversion['tables'][11] = 'wfdownloads_ratings';
...
if(is_object($xoopsModule) && $xoopsModule->getVar('dirname') == $modversion['dirname'] && $xoopsModule->getVar('isactive'))
{
	if(is_object($xoopsUser) && ($xoopsModuleConfig['submissions'] == 2 || $xoopsModuleConfig['submissions'] == 4))
	{
		...
		if(array_intersect($xoopsModuleConfig['submitarts'], $groups)) {$submissions = 1;}
	}
	else
	{
		if($xoopsModuleConfig['anonpost'] == 2 || $xoopsModuleConfig['anonpost'] == 4) {$submissions = 1;}
	}
}
...
$modversion['config'][] = array(
	...
	'formtype' 	=> 'textarea',
	'valuetype' 	=> 'array',
	'default' 	=> 'None|Apache License (v. 1.1)|Apple Public Source License (v. 2.0)|Berkeley Database License|BSD License (Original)|Common Public License|FreeBSD Copyright (Modifizierte BSD-Lizenz)|GNU Emacs General Public License|GNU Free Documentation License (FDL) (v. 1.2)|GNU General Public License (GPL) (v. 1.0)|GNU General Public License (GPL) (v. 2.0)|GNU Lesser General Public License (LGPL) (v. 2.1)|GNU Library General Public License (LGPL) (v. 2.0)|Microsoft Shared Source License|Mozilla Public License (v. 1.1)|Open Software License (OSL) (v. 1.0)|Open Software License (OSL) (v. 1.1)|Open Software License (OSL) (v. 2.0)|Open Public License|Open RTLinux Patent License (v. 1.0)|PHP License (v. 3.0)|W3C Software Notice and License|Wide Open License (WOL)|X.Net License|X Window System License');
