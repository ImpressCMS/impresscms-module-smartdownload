...
// added in 3.1 RC1
define("_MI_WFD_BINDEX","Index"); // changed
define("_MI_WFD_INDEXPAGE","Index Management"); // changed
define("_MI_WFD_MCATEGORY","Categories"); //changed
define("_MI_WFD_MDOWNLOADS","Files"); //changed
define("_MI_WFD_MMIMETYPES","Mimetypes"); //changed
define("_MI_WFD_PERMISSIONS","Permissions"); //changed
define('_MI_WFD_MODULE_MAILLIST', "SmartFactory Mailing Lists"); // changed
define('_MI_WFD_MODULE_MAILANNOUNCEMENTSDSC', "Get the latest announcements from SmartFactory."); // changed
...
define("_MI_WFD_ANONPOSTDSC","Allow Anonymous users to submit new Downloads/Mirrors to your website?"); // changed
define('_MI_WFD_AUTOAPPROVE','Auto Approve Submitted Downloads/Mirrors'); // changed
define('_MI_WFD_AUTOAPPROVEDSC','Select to approve submitted downloads/mirrors without moderation.'); // changed
define('_MI_WFD_DOWNLOADMINPOSTS', "Minimum posts required to download"); // changed
define('_MI_WFD_DOWNLOADMINPOSTSDSC', "Enter the minimum number of posts required to download a file"); // changed
...
EVENT WILL SMARTFACTORY BE LIABLE FOR ANY INDIRECT, PUNITIVE, SPECIAL,
INCIDENTAL OR CONSEQUENTIAL DAMAGES HOWEVER THEY MAY ARISE AND EVEN IF
SMARTFACTORY HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.."); // changed
define('_MI_WFD_AUTHOR_CREDITSTEXT',"The SmartFactory Team would like to thank the following people for their help and support during the development phase of this module:<br /><br />tom, mking, paco1969, mharoun, Talis, m0nty, steenlnielsen, Clubby, Geronimo, bd_csmc, herko, LANG, Stewdio, tedsmith, veggieryan, carnuke, MadFish, Kiang<br />and anyone else who has contributed to either directly or indirectly."); // changed
define('_MI_WFD_COPYRIGHTIMAGE', "Images copyright WF-Project/SmartFactory and may only be used with permission"); // changed
...
/* End add block */
define("_MI_WFD_SUBMITARTDSC", "Select groups that can submit new downloads.<br />Webmasters are automatically selected!"); // changed
define("_MI_WFD_USETHUMBSDSC", "Supported file types: JPG, GIF, PNG.<div style='padding-top: 8px;'>WF-Downloads will use thumb nails for images (category & screenshots). Set to 'No' to use orginal image if the server does not support this option.</div>"); // changed


// added in 3.2 Final
define('_MI_WFD_BNAME1_DSC','Shows recently added download files');
define('_MI_WFD_BNAME2_DSC','Shows most downloaded files');
define('_MI_WFD_BNAME3_DSC','Shows most downloaded files by top categories');
?>