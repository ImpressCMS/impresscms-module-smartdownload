...
define("_AM_WFD_FILE_DLURL", "Remote URL: "); // changed
define("_AM_WFD_DB_IMPORT", "Import"); // changed
...
define("_AM_WFD_FILE_FILENAME", "Local Filename:<br /><br /><span style='font-weight: normal;'>Note: If using local file as download, then you must also enter the correct filetype below!</span>"); // changed
...
define("_AM_WFD_MOD_DESCRIPTION", "Description: "); // changed
define("_AM_WFD_MOD_URL", "Remote Url: "); // changed
define("_AM_WFD_DBERROR", "Database Access Error: Please report this error to the SmartFactory Website"); // changed
