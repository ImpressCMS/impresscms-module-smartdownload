<?php
//Cr�ditos de la traducci�n: ver. 3.0 chencho; Francisco Portero ver. 3.1RC1; Riosoft ver. 3.1 final
//Revisi�n inicial de la traducci�n y a�adidos para la ver. 3.2 RC1 por debianus para es.impresscms.org
...
define("_AM_WFD_BINDEX", "&Iacute;ndice pr&iacute;ncipal de administraci�n.");
...
define("_AM_WFD_CCATEGORY_AREUSURE", "Atenci�n: est&aacute; seguro que desea eliminar la categor&iacute;a y todos sus ficheros y comentarios?");
define("_AM_WFD_CCATEGORY_NOEXISTS", "Debe crear una categor&iacute;a antes de a&ntilde;adir nuevos ficheros");
define("_AM_WFD_FCATEGORY_GROUPPROMPT", "Permisos de acceso a la categor&iacute;a:<div style='padding-top: 8px;'><span style='font-weight: normal;'>Seleccione los Grupos de Usuarios que tendr�n permisos de acceso a la misma.</span></div>");
...
define("_AM_WFD_CCATEGORY_CHILDASPARENT", "No puede configurar una categor�a hija como la categor�a padre");
/* 
* Index page Defines
*/ 
...
define("_AM_WFD_DOWN_DELETEFILE", "Atenci�n: �Est&aacute; seguro que desea eliminar esta imagen?");
...
define("_AM_WFD_DOWN_UPLOADPATHDSC", "Tenga en cuenta que debe indicar necesariamente la ruta completa del servidor hacia el directorio donde se alojar�n los archivos.");
...
define("_AM_WFD_MINDEX_NODOWNLOADSFOUND", "Atenci�n: no hay ficheros que mostrar");
...
define("_AM_WFD_MOD_MODREQUESTSINFO", "Informaci�n de archivos modificada");
define("_AM_WFD_MOD_MODID", "ID");
define("_AM_WFD_MOD_MODTITLE", "T�tulo");
...
define("_AM_WFD_MOD_MODIFYSUBMIT", "Envi�");
define("_AM_WFD_MOD_ORIGINAL", "Detalles originales de la descarga");
define("_AM_WFD_MOD_REQDELETED", "Petici�n de modificaci�n de la base de datos eliminada");
...
define("_AM_WFD_FILE_SUBMITTERID", "Id del propietario del env�o: <br /><br />D�jelo tal cual a menos que desee cambiar el propietario del env�o");
...
define("_AM_WFD_FILE_FILETYPE", "Tipo de archivo:<br /><br /><span style='font-weight: normal;'>Nota: Si usa un archivo local como descarga, tendr� que introducir el tipo de archivo correctamente a continuaci�n</span> ");
...
define("_AM_WFD_BROKEN_IGNOREDESC", "<b>Ignorar</b>. Solamente el informe de enlace roto se eliminar�.");
...
define("_AM_WFD_BROKEN_ACKDESC", "<b>Reconocer:</b> activar� la aceptaci�n del informe de enlace roto y se mostrar� como pendiente de soluci�n.");
...
define("_AM_WFD_BROKEN_DATESUBMITTED", "Fecha de env�o");
define("_AM_WFD_BROKEN_ACTION", "Acci�n");
...
define("_AM_WFD_ICO_URL","A�adir URL relacionada");
define("_AM_WFD_ICO_ADD","A�adir");
define("_AM_WFD_ICO_APPROVE","Aprobar");
define("_AM_WFD_ICO_STATS","Estad�sticas");
...
define("_AM_WFD_DB_MSG_NEWFIELD_ERR", "Error al a�dir el campo %s");
define("_AM_WFD_DB_NEEDUPDATE", "Su base de datos est� obsoleta. Necesita actualizar las tablas.<br><b>Recuerde que SmartFactory le recomienda encarecidamente que haga una copia de seguridad de todas las tablas antes de iniciar el proceso de actualizaci�n.</b><br>");
define("_AM_WFD_DB_NOUPDATE", "Su base de datos ya est� actualizada. No es necesario actualizarla.");
define("_AM_WFD_DB_UPDATE_DB", "Actualizando la base de datos");
define("_AM_WFD_DB_UPDATE_ERR", "Se encontraron errores actualizando a la versi�n %s");
define("_AM_WFD_DB_UPDATE_NOW", "Actualizar ahora");
define("_AM_WFD_DB_UPDATE_OK", "Se actualiz� correctamente a la versi�n %s");
define("_AM_WFD_DB_UPDATE_TO", "Actualizando a la versi�n %s");

define("_AM_WFD_GOMOD", "Ir a m�dulo");
define("_AM_WFD_UPDATE_MODULE", "Actualizar el m�dulo");
...
define("_AM_WFD_CONT2","Ant�rtida");
...
// A�adidos para la versi�n 3.1 FINAL
...
define("_AM_WFD_MOD_RATING", "Valoraci�n: ");
...
define("_AM_WFD_MOD_REQUESTDATE", "Fecha de petici�n: ");
define("_AM_WFD_MOD_IPADDRESS", "Direcci�n IP: ");
...
define("_AM_WFD_FFS_STANDARD_FORM", "No, usar el formulario est�ndar");
define("_AM_WFD_FFS_CUSTOM_FORM", "�Usar un formulario personalizado para esta categor�a?");
define("_AM_WFD_FFS_DOWNLOADTITLE", "Enviar un archivo en la categor�a {category}.");
define("_AM_WFD_FFS_EDITDOWNLOADTITLE", "Modificando un archivo en la categor�a '{category}'.");
define("_AM_WFD_FFS_BACK", "Regresar");
define("_AM_WFD_FFS_RELOAD", "Recargar");
define("_MD_WFD_CATEGORYC", "Categor�a: ");  // _MD to reuse the category form
define("_MD_WFD_FFS_SUBMITCATEGORYHEAD", "�En qu� categor�a desea incluir el env�o?");
...
define("_MD_WFD_FILETITLE", "T�tulo de la descarga: ");
define("_MD_WFD_DLURL", "URL de la descarga: ");
define("_MD_WFD_UPLOAD_FILEC", "Enviar archivo: ");
define("_MD_WFD_DESCRIPTION", "Descripci�n");
define("_AM_WFD_FILE_VERSIONTYPES", "Estado de la versi�n: ");
//A�adido en la revisi�n 1473
