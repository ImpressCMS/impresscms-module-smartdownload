...
define("_MD_WFD_DOWNLOADMINPOSTS", "Necesitas tener un n�mero de env�os m�s alto<br />Antes de poder descargar ficheros");
define("_MD_WFD_UPLOADMINPOSTS", "Necesitas tener un n�mero de env�os m�s alto<br />Antes de poder subir ficheros");
define("_MD_WFD_MINPOSTS", "Necesitas tener un n�mero de env�os m�s alto<br />Antes de poder subir/descargar ficheros");

define("_MD_WFD_SUBCATLISTING", "Listado de categor�as");
define("_MD_WFD_ISADMINNOTICE", "Administrador: hay un problema con esta imagen.");
define("_MD_WFD_THANKSFORINFO", "Gracias por su env�o. Usted ser&aacute; notificado una vez que su env�o sea aprobado por el administrador.");
define("_MD_WFD_ISAPPROVED", "Gracias por su env�o. Acaba de ser aprobado y aparecer&aacute; inmediatamente en el listado.");
...
define("_MD_WFD_NOPERMISETOLINK", "Este fichero no pertenece al sitio del cual procede <br /><br />Por favor mande un correo electr�nico al administrador del sitio del cual proviene y d&iacute;gale:   <br /><b>NOT TO LEECH OTHER SITES LINKS</b> <br /><br /><b>Definition of a Leecher:</b> One who is to lazy to link from his own server or steals other peoples hard work and makes it look like his own <br /><br />  Your IP address <b>has been logged</b>.");
define("_MD_WFD_SUMMARY", "Sumario<br /><br /><span style='font-weight: normal;'>Puede dejar esto en blanco<br />El sumario ser� creado en blanco</span>");
...
define("_MD_WFD_POPULARITYLTOM", "Popularidad (de menos a m�s)");
define("_MD_WFD_POPULARITYMTOL", "Popularidad (de m�s a menos)");
...
define("_MD_WFD_REVIEWS", "An�lisis:");
...
define("_MD_WFD_BEFORESUBMIT", "Antes de enviar un informe de una descarga err&oacute;nea, por favor, cerci&oacute;rese de que la descarga ha sido eliminada en efecto, y de que no se trata de una ca�da temporal del servidor del cual procede el archivo.");
...
define("_MD_WFD_VERSIONC", "Versi�n: ");
define("_MD_WFD_FILESIZEC", "Tama�o: ");
...
define("_MD_WFD_ALREADYREPORTED", "Usted ya ha enviado un informe de fichero err�neo de este recurso.");
...
define("_MD_WFD_SUB_SNEWMNAMEDESC", "<ul><li>>Todas las descargas nuevas son aprobadas por los administradores en un plazo de 24 horas antes de aparecer en nuestro listado.</li><li>Nos reservamos el derecho de rechazar cualquier env�o, as&iacute; como modificar el contenido sin aprobaci&oacute;n.</li></ul>");
...
define("_MD_WFD_DATEREPORTED", "Fecha de env�o: ");
...
define("_MD_WFD_BROKENREPORTED", "Informe de fichero err�neo enviado");
...
define("_MD_WFD_CLICKHERE", "Haga click aqu�");
define("_MD_WFD_BROKENFILE", "Fichero err�neo");
define("_MD_WFD_PLEASEREPORT", "Por favor informe de este fichero err�neo al administrador. ");
// Reviews
...
define("_MD_WFD_REV_DESCRIPTION", "An�lisis:");
...
");
define("_MD_WFD_ISNOTAPPROVED", "Su env�o tiene que ser aprobado por un moderador primero.");
...
define("_MD_WFD_HISTORYD", "A&ntilde;adir nueva Historia de la Descarga:<br /><br /><span style='font-weight: normal;'>La fecha de env�o ser&aacute; a&ntilde;adida autom&aacute;ticamente.</span>");
...
define("_MD_WFD_REVIEWTITLE", "An�lisis de usuarios");
define("_MD_WFD_REVIEWTOTAL", "<b>An�lisis totales:</b> %s");
define("_MD_WFD_USERREVIEWSTITLE", "Usuarios que han analizado la descarga");
define("_MD_WFD_USERREVIEWS", "An�lisis de usuarios le&iacute;dos en %s");
...
//
define("_MD_WFD_NEWLAST","Nuevo env�o antes de la &uacute;ltima semana");
define("_MD_WFD_NEWTHIS","Nuevo env�o en esta semana");
define("_MD_WFD_THREE","Nuevo env�o en los &uacute;ltimos tres d&iacute;as");
define("_MD_WFD_TODAY","Nuevo env�o hoy");
...
define("_MD_WFD_MIRROR_NOTALLOWESTOSUBMIT", "Usted no est� autorizado para enviar mirrors");
...
define("_MD_WFD_MIRROR_DISABLED", "Comprobaci�n del servidor desabilitada.");
//continents (used in mirrors page)
define("_MD_WFD_CONT1","�frica");
define("_MD_WFD_CONT2","Ant�rtida");
...
define("_MD_WFD_CONT7","Ocean�a");


define("_MD_WFD_ADMIN_PAGE",":: Administraci�n ::");
...
// a�adido a la versi�n 3.1 FINAL
...
define("_MD_WFD_LEGENDTEXTCATRSS", "Categor�as de las fuentes de RSS");
...
define("_MD_WFD_FFS_SUBMITCATEGORYHEAD", "�En qu� categor�a desea incluir el archivo?");//Which Category of file do you want to submit?
...
define("_MD_WFD_FFS_DOWNLOADTITLE", "Enviando un archivo en la categor�a '{category}' .");
