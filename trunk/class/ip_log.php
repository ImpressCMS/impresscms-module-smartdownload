<?php
// $Id: report.php,v 1.3 2007/09/30 13:47:53 m0nty_ Exp $
// ------------------------------------------------------------------------ //
...
class WfdownloadsIP_LogHandler extends XoopsPersistableObjectHandler {
	...
	function WfdownloadsIP_LogHandler($db) {
		$this->XoopsPersistableObjectHandler($db, 'wfdownloads_ip_log', 'WfdownloadsIP_Log', 'ip_logid');
	}
