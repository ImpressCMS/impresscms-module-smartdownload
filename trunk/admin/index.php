...
$mytree = new icms_view_Tree($xoopsDB -> prefix('wfdownloads_cat'), "cid", "pid");
...
function Download()
{
    ...
    if ($numrows)
    {
        ...
        $criteria = new icms_db_criteria_Item("mime_admin", 1);
    ...
    if ($lid)
    {
        ...
        $reg_criteria = new icms_db_criteria_Compo(new icms_db_criteria_Item('lid', $lid));
        $reg_criteria->add(new icms_db_criteria_Item("ratinguser", 0, ">"));
        ...
        $anon_criteria = new icms_db_criteria_Compo(new icms_db_criteria_Item('lid', $lid));
        $anon_criteria->add(new icms_db_criteria_Item("ratinguser", 0, ">"));
        ...
        if ($votesreg == 0)
        {
            ...
            $criteria = new icms_db_criteria_Item("uid", "(".implode(',', $uids).")", "IN");
        ...
        if ($votesanon == 0)
        {
            ...
            $criteria = new icms_db_criteria_Item("uid", 0);
            $userratings = $rating_handler->getUserAverage($criteria);
...
switch ($op)
{
    ...
    $totalnewdownloads = $download_handler->getCount(new icms_db_criteria_Item("published", 0));
    $totaldownloads = $download_handler->getCount(new icms_db_criteria_Item("published", 0, ">"));
    ...
    if ($totaldownloads > 0)
    {
         ...
         * Auto Publish
         */
        $criteria = new icms_db_criteria_Item("published", time(), ">");
         ...
         */
        $criteria = new icms_db_criteria_Compo();
        $criteria->add(new icms_db_criteria_Item("expired", time(), "<"), 'AND');
        $criteria->add(new icms_db_criteria_Item("expired", 0, "<>"), 'AND');
        ...
        $criteria = new icms_db_criteria_Item("offline", 1);
