...
switch ($op)
{
    ...
    $download_handler = icms_getModuleHandler('download');
    $criteria = new icms_db_criteria_Item("published", 0);
    ...
    if ($new_array_count > 0)
    {
        foreach (array_keys($new_array) as $i)
        {
            ...
            $modify = "<a href='".WFDOWNLOADS_URL."admin/index.php?op=Download&amp;lid=" . $new['lid'] . "'>" . $imagearray['editimg'] . "</a>";
            $delete = "<a href='".WFDOWNLOADS_URL."admin/index.php?op=delDownload&amp;lid=" . $new['lid'] . "'>" . $imagearray['deleteimg'] . "</a>";
    ...
    $pagenav = new icms_view_PageNav($new_array_count, $xoopsModuleConfig['admin_perpage'], $start, 'start');
