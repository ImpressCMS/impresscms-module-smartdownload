...
switch ($op) {
    ...
    default:
        ...
        $form = new icms_form_Theme('Upgrade WF-Downloads',"form", $_SERVER['REQUEST_URI']);
        ...
        if (!wfdownloads_TableExists('wfdownloads_meta')) {
            $updateButton = new icms_form_elements_Button("Update WF-Downloads", "upd_button", "Update", "submit");
