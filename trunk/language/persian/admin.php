...
//added in 3.2 RC1
define("_AM_WFD_FFS_SUBMITBROKEN", "ارسال");
define("_AM_WFD_FFS_STANDARD_FORM", "نه از فرم استاندارد استفاده کنید");
define("_AM_WFD_FFS_CUSTOM_FORM", "برای این شاخه از فرم دست ساز استفاده کنید؟");
define("_AM_WFD_FFS_DOWNLOADTITLE", "ارسال یک فایل '{category}'.");
define("_AM_WFD_FFS_EDITDOWNLOADTITLE", "ویرایش یک فایل '{category}'.");
define("_AM_WFD_FFS_BACK", "بازگشت");
define("_AM_WFD_FFS_RELOAD", "ری لود");
define("_MD_WFD_CATEGORYC", "شاخه: "); // _MD to reuse the category form
define("_MD_WFD_FFS_SUBMITCATEGORYHEAD", "میخواهید فایل را در چه شاخه ای بازگذاری کنید؟");
define("_MD_WFD_FFS_DOWNLOADDETAILS", "جزییات فایل:");
define("_MD_WFD_FFS_DOWNLOADCUSTOMDETAILS", "جزییان فایل دستی:");
define("_MD_WFD_FILETITLE", "عنوان فایل: ");
define("_MD_WFD_DLURL", "آدرس فایل: ");
define("_MD_WFD_UPLOAD_FILEC", "بارگذاری فایل: ");
define("_MD_WFD_DESCRIPTION", "شرح");
define("_AM_WFD_DOWN_METAVERSION", "<b>نسخه متا دریافت فایل<b> ");
?>