...
/**
 * $Id: modinfo.php,v 1.5 2006/04/29 15:45:48 malanciault Exp $
 * Module: WF-Downloads
 * Version: v2.0.5a
...
define('_MI_WFD_TEMPLATESETDSC', 'Choisissez le set de templates à utiliser.<br />Cela vous permettra de choisir comment vos fichiers seront affichés.');
...
define('_MI_WFD_GLOBAL_NEWCATEGORY_NOTIFYCAP', 'Notifiez-moi quand une catégorie de fichiers est créée.');
define('_MI_WFD_GLOBAL_NEWCATEGORY_NOTIFYDSC', 'Notifiez-moi quand une catégorie de fichiers est créée.');
define('_MI_WFD_GLOBAL_NEWCATEGORY_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notify : Nouvelle catégorie de fichiers');                              
...
define('_MI_WFD_GLOBAL_NEWFILE_NOTIFYCAP', 'Notifiez-moi dès qu\'un nouveau fichier est publié.');
define('_MI_WFD_GLOBAL_NEWFILE_NOTIFYDSC', 'Notifiez-moi dès qu\'un nouveau fichier est publié.');
