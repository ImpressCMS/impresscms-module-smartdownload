...
define('_MI_WFD_CHECKHOST', 'غیر فعال کردن دریافت مستقیم: <br />  اگر بله را انتخاب کنید در صورت لینک داده شدن به فایل ها از خارج سایت نمیتوان فایل را دریافت کرد و پیغامی مبنی بر دزدی لینک نوشته خواهد شد ');
define('_MI_WFD_REFERERS', 'این سایت ها میتوانند مستقیما به فایل های شما لینک دهند <br />هر کدام را با  | از هم جدا کنید ');

define('_MI_WFD_CAT_IMGWIDTH', 'عرض فایل تصویری نمایش داده شده برای شاخه ها');
define('_MI_WFD_CAT_IMGWIDTHDSC', 'عرض فایل تصویری را که برای نمایش شاخه ها استفاده می شود مشخص میکند');
define('_MI_WFD_CAT_IMGHEIGHT', 'طول فایل تصویری نمایش داده شده برای شاخه ها');
define('_MI_WFD_CAT_IMGHEIGHTDSC', 'طول فایل تصویری را که برای نمایش شاخه ها استفاده می شود مشخص میکند');
...
define('_MI_WFD_AUTOAPPROVE','تایید خودكار فایل/ همسان های ارسال شده');
...
define('_MI_WFD_ALLOWUPLOADSDSC','اجازه به كاربران برای ارسال مستقیم فایل به سایت شما<br /> این شامل هم فایل و هم تصاویر نمونه است');
define('_MI_WFD_ALLOWUPLOADSGROUP','دسترسی گروه ها برای ارسال فایل:');
define('_MI_WFD_ALLOWUPLOADSGROUPDSC','گروه هایی را که برای بارگذاری فایل به سایت دسترسی دارند انتخاب کنید.<br />این دسترسی شامل هم فایل و هم تصویر نمونه آن است!');
...
define("_MI_WFD_USETHUMBSDSC", "فایل های پشتیبانی شونده: JPG, GIF, PNG.<div style='padding-top: 8px;'>ماژول دریافت فایل از تصاویر تمبری شکل برای تصاویر استفاده میکند(هم برای شاخه ها و هم تصاویر نمونه).اگر سرور شما از این گزینه پشتیبانی نمیکند روی 'نه' قرار دهیدتا از تصویر اصلی استفاده شود.</div>");
...
define('_MI_WFD_MAXSHOTS', 'حداکثر تعداد تصویر نمونه را انتخاب کنید:');
define('_MI_WFD_MAXSHOTSDSC', 'تعیین کنید که حداکثر چه تعداد تصویر نمونه برای یک فایل میتوان بارگذاری کرد.');

define("_MI_WFD_SUBMITART", "دسترسی گروه ها برای ارسال: ");
define("_MI_WFD_SUBMITARTDSC", "وب مستر ها به طور خودکار انتخاب می شوند!<br />گروه هایی را که برای ارسال مورد جدید به پایگاه داده دسترسی دارند انتخاب کنید. توجه کنید که این دسترسی برای آپلود فایل حقیقی نیست");
...
define('_MI_WFD_FILE_FILEMODIFIED_NOTIFY', 'فایل ویرایش شده');
define('_MI_WFD_FILE_FILEMODIFIED_NOTIFYCAP', 'هنگامی که این فایل ویرایش شد مرا با خبر کن.');
define('_MI_WFD_FILE_FILEMODIFIED_NOTIFYDSC', 'دریافت آگهی هنگامی که این فایل ویرایش شد.');
define('_MI_WFD_FILE_FILEMODIFIED_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} آگهی رسانی خودکار : فایل ویرایش شده');

define('_MI_WFD_CATEGORY_FILEMODIFIED_NOTIFY', 'فایل ویرایش شده');
define('_MI_WFD_CATEGORY_FILEMODIFIED_NOTIFYCAP', 'هنگامی که این فایل در این شاخه ویرایش شد مرا با خبر کن.');
define('_MI_WFD_CATEGORY_FILEMODIFIED_NOTIFYDSC', 'دریافت آگهی رسانی هنگامی که این فایل در این شاخه ویرایش شد.');
define('_MI_WFD_CATEGORY_FILEMODIFIED_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} آگهی رسانی خودکار : فایل ویرایش شده');

define('_MI_WFD_GLOBAL_FILEMODIFIED_NOTIFY', 'فایل ویرایش شده');
define('_MI_WFD_GLOBAL_FILEMODIFIED_NOTIFYCAP', 'هنگامی که هر فایلی ویرایش شد مرا با خبر کن.');
define('_MI_WFD_GLOBAL_FILEMODIFIED_NOTIFYDSC', 'دریافت آگهی هنگامی که هر فایلی ویرایش شد.');
define('_MI_WFD_GLOBAL_FILEMODIFIED_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} آگهی رسانی خودکار : فایل ویرایش شده');
/* End add block */
...
define('_MI_WFD_MIRROR_ENABLEONCHK','فعال کردن بررسی آن لاین سرور');
