...
define("_MD_WFD_SCREENSHOT", "تصویر نمونه 1:");
...
// added in 3.2 RC1
define("_MD_WFD_FFS_SUBMITCATEGORYHEAD", "میخواهید فایل را در کدام شاخه بارگذاری کنید؟");
define("_MD_WFD_FFS_DOWNLOADDETAILS", "جزییات فایل:");
define("_MD_WFD_FFS_DOWNLOADCUSTOMDETAILS", "جزییات فایل دستی:");
define("_MD_WFD_FFS_BACK", "بازگشت");
define("_MD_WFD_FFS_DOWNLOADTITLE", "ارسال یک فایل '{category}'.");
define("_MD_WFD_SCREENSHOT2", "تصویر نمونه 2:");
define("_MD_WFD_SCREENSHOT3", "تصویر نمونه 3:");
define("_MD_WFD_SCREENSHOT4", "تصویر نمونه 4:");
define("_MD_WFD_LEGENDTEXTRSS", "RSS");
define("_MD_WFD_LEGENDTEXTCATRSS", "RSS شاخه");
define("_MD_WFD_NEEDLOGINVIEW", "شما باید اول وارد شوید!");
define("_MD_WFD_BYTES", " بایت");
define("_MD_WFD_KILOBYTES", "کیلو بایت");
define("_MD_WFD_MEGABYTES", "مگا بایت");
define("_MD_WFD_GIGABYTES", "گیگا بایت");
define("_MD_WFD_TERRABYTES", "ترا بایت");
?>