...
define("_AM_WFD_AREVIEWS_EDIT", "<b>&Auml;ndern-</b> Rezension &auml;ndern und anschlie&szlig;end freigeben.");
...
define("_AM_WFD_FILE_FILENAME", "Lokaler Dateiname:<br /><br /><span style='font-weight: normal;'>ANMERKUNG: Wenn Du die lokale Datei als Download verwendest, m&uuml;ssen auch korrekten Dateitype unten angegeben werden!</span>");
...
define("_AM_WFD_BROKEN_DELETE_ALT", "L&ouml;schen des Reports der berichteten Downloaddaten und defekte ");
...
define("_AM_WFD_BROKEN_ACK_ALT", "Best&auml;tigen des Zustand des defekten Dateienliste");
define("_AM_WFD_BROKEN_CONFIRMDESC", "<b>Best&auml;tigt</b> Setze den Status des Defektberichts auf *best&auml;tigt*.");
define("_AM_WFD_BROKEN_CONFIRM_ALT", "Best&auml;tigen des Zustand des defekten Dateienliste");
...
define("_AM_WFD_AMIRRORS_APPROVE", "<b>Freigabe</b> eines Neuen Mirror ohne &Uuml;berpr&uuml;fung.");
...
define("_AM_WFD_MIRROR_MUSTBEVALID", "Das Homepage Logo muss ein g&uuml;ltige Bilddatei im %s Verzeichnis (ex. shot.gif) sein. Wird nichts eingegeben dann wird kein Logo angezeigt.");
