...
define("_MD_WFD_NEEDLOGINVIEW", "Bitte zuerst einloggen!");
...
define("_MD_WFD_POPULAR", "Populär");
define("_MD_WFD_NEWTHISWEEK", "Neu diese Woche");
define("_MD_WFD_UPTHISWEEK", "Aktualisiert diese Woche");
define("_MD_WFD_POPULARITYLTOM", "Popularität (geringste bis h&aouml;chste Anzahl Hits)");
define("_MD_WFD_POPULARITYMTOL", "Popularität (h&aouml;chste bis geringste Anzahl Hits)");
define("_MD_WFD_TITLEATOZ", "Titel (A bis Z)");
define("_MD_WFD_TITLEZTOA", "Titel (Z bis A)");
define("_MD_WFD_DATEOLD", "Datum (ältere zuerst)");
define("_MD_WFD_DATENEW", "Datum (neuere zuerst)");
define("_MD_WFD_RATINGLTOH", "Bewertung (niedrigster bis höchste Bewertung)");
define("_MD_WFD_RATINGHTOL", "Bewertung (höchster bis niedrigste Bewertung)");
...
define("_MD_WFD_BEFORESUBMIT", "Bevor eine defekte Ressource gemeldet wird sollte bitte überprüft werden, ob die gesuchte Ressource wirklich nicht mehr verfügbar, oder die entsprechende Seite nur temporär offline ist.");
...
define("_MD_WFD_VOTEONCE", "Bitte nicht mehrfach für die gleiche Ressource abstimmen.");
...
define("_MD_WFD_POPULARITY", "Popularität");
...
define("_MD_WFD_MUSTREGFIRST", "Leider hast Du nicht die Berechtigung für diese Aktion.<br />Bitte zunächst registrieren oder anmelden!");
define("_MD_WFD_NORATING", "Keine Wertung ausgewählt.");
define("_MD_WFD_CANTVOTEOWN", "Du darfst für die Ressource die Du eingesendet hast nicht abstimmen.<br />Alle Stimmen werden geloggt und überprüft.");
define("_MD_WFD_SUBMITDOWNLOAD", "Download einsenden");
define("_MD_WFD_SUB_SNEWMNAMEDESC", "<ul><li>Alle neuen Downloads werden zunächst verifiziert. Es kann daher bis zu 24 Stunden dauern, ehe sie in unserem Listing erscheinen.</li><li>Wir behalten uns das Recht vor, eingesendete Ressourcen abzulehnen oder ohne Nachfrage die Informationen zu modifizieren.</li></ul>");
...
define("_MD_WFD_LEGENDTEXTNEWLAST", "älter als 1 Woche");
...
define("_MD_WFD_FILENOTEXIST", "FEHLER: Datei existiert nicht oder Datei nicht gefunden!");
define("_MD_WFD__MD_WFD_FILENOTOPEN", "FEHLER: Datei kann nicht geöffnet werden!");
...
Bitte das Formular komplett ausfüllen und wir werden diesen dann so schnell wie möglich überprüfen.<br /><br />
Danke dass Du Dir die Zeit nimmst Deine Meinung abzugeben. Du ermöglichst damit anderen Usern, gute Software schneller zu finden.<br /><br />Alle Rezensionen werden vor der Veröffentlichung von den Webmastern überprüft.
");
define("_MD_WFD_ISNOTAPPROVED", "Dein Beitrag muß erst von einem Moderator freigegeben werden.");
define("_MD_WFD_LICENCEC", "Software Lizenz: ");
define("_MD_WFD_LIMITATIONS", "Software Beschränkungen: ");
...
define("_MD_WFD_HISTORYD", "Neue History hinzufügen:<br /><br /><span style='font-weight: normal;'>Das Einsendedatum wird automatisch hinzugefügt.</span>");
...
//submit.php
define("_MD_WFD_NOTALLOWESTOSUBMIT","Keine Berechtigung zum Übertragen von Dateien");
define("_MD_WFD_INFONOSAVEDB","Information wurde nicht in die Datenbank übernommen: <br /><br />");
...
define("_MD_WFD_ADDREVIEW", "Bericht hinzufügen");
...
//mirror.php
define("_MD_WFD_MIRROR_AVAILABLE", "Verfügbare Mirrors:");
...
define("_MD_WFD_MIRROR_NOTALLOWESTOSUBMIT", "Du hast keine Zugriffsrechte Mirrors zu benützen");
define("_MD_WFD_MIRRORS", "Download Mirrors:");
define("_MD_WFD_USERMIRRORSTITLE", "Verfügbare Download Mirrors");
...
define("_MD_WFD_MIRROR_SUBMITMIRROR", "Übertragen an den Mirror");
define("_MD_WFD_ERROR_CREATEMIRROR", "Fehler beim erstellen des Mirror");
define("_MD_WFD_MIRROR_SNEWMNAMEDESC", "
Bitte fülle das untenstehente Formular komplett gewissenhaft aus und wir fügen deinen Mirror so bald als möglich dazu.<br /><br />
...
define("_MD_WFD_MIRROR_DISABLED", "Server-Host Überprüfung abgeschaltet.");
...
define("_MD_WFD_DOWNLOAD_MOST_POPULAR","Populärste Downloads");
define("_MD_WFD_DOWNLOAD_MOST_RATED","Am besten Bewertete Downloads");


// added - start - March 4 2006 - jpc
define("_MD_WFD_FFS_SUBMITCATEGORYHEAD", "Zu welcher Kategorie willst Du Dateien Übertragen?");
define("_MD_WFD_FFS_DOWNLOADDETAILS", "Download Details:");
define("_MD_WFD_FFS_DOWNLOADCUSTOMDETAILS", "Anwenderspezifische Details:");
define("_MD_WFD_FFS_BACK", "Zurück");
define("_MD_WFD_FFS_DOWNLOADTITLE", "Übertragen in '{category}' Datei.");
